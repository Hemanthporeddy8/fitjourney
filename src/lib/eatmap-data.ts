    ...
    families: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'chili_pepper_item', emoji: '🌶️', name: 'Chili Pepper' },
        ],
      },
      {
...
export const detailedDietProfilesData: DetailedDietProfile[] = [
  ...
  { id: 'flexitarian', name: 'Flexitarian', emoji: '🍽️🌿', category: 'Animal-Inclusive', description: 'Mostly plant-based, with occasional, limited consumption of meat/fish.', includes: ['Primarily plant-based', 'Occasional meat/fish'], excludes: ['None strictly (limits meat)'] },
  ...
  { id: 'sattvic', name: 'Sattvic', emoji: '🧘‍♂️', category: 'Lifestyle or Belief-Based', description: 'Pure, essential foods promoting clarity and calmness (Ayurvedic).', includes: ['Fresh vegetables', 'Fruits', 'Dairy', 'Grains', 'Legumes', 'Nuts'], excludes: ['Onion', 'Garlic', 'Meat', 'Eggs', 'Stimulants', 'Stale food'] },
  { id: 'jain', name: 'Jain', emoji: '🕊️', category: 'Lifestyle or Belief-Based', description: 'Strict vegetarian diet adhering to principles of non-violence.', includes: ['Fruits', 'Non-root vegetables', 'Dairy', 'Grains', 'Legumes'], excludes: ['Root vegetables (potatoes, onions, garlic)', 'Meat', 'Eggs', 'Honey', 'Certain spices'] },
  ...
  { id: 'intermittent_fasting', name: 'Intermittent Fasting Pattern', emoji: '⏱️', category: 'General', description: 'Cycles between periods of eating and voluntary fasting.', includes: ['All food groups (during eating window)'], excludes: ['Food/caloric beverages (during fasting window)'] },
];
