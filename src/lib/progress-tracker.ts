...
export interface StoredScan extends ScanResult {
  ...
  isVerified?: boolean;  // User confirmed the result
  userBf?:     number;   // User corrected BF%
  feedback?:   'good' | 'bad';
}
...
// â”€â”€ SCAN HISTORY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
<body>
  <h1>ðŸ‹ï¸ FitJourney Body Report</h1>
  <p class="sub">
    ${profile?.name ? `${profile.name} Â· ` : ''}
    ${first.date} â†’ ${last.date} Â·
  ...
  ${profile?.goalBf ? `
  <h2>Goal Progress</h2>
  <p>Target: <strong>${profile.goalBf}% body fat</strong> Â· 
  ...
  <table>
    ...
    <tr><td>Essential Fat</td><td>2â€“5%</td><td>10â€“13%</td></tr>
    <tr><td>Athlete</td><td>6â€“13%</td><td>14â€“20%</td></tr>
    <tr><td>Fitness</td><td>14â€“17%</td><td>21â€“24%</td></tr>
    <tr><td>Average</td><td>18â€“24%</td><td>25â€“31%</td></tr>
    <tr><td>Above Average</td><td>25%+</td><td>32%+</td></tr>
  </table>

  <div class="note">
    âš ï¸ This is not a medical device. Results are for fitness tracking only.
    For clinical body composition assessment, consult a healthcare professional.
  </div>

  <div class="footer">
    Generated by FitJourney Â· Your data stays on your device Â· 
